...
@NonnullByDefault
public class TerraSkillDamageEvent extends TerraEntityDamageByEntityEvent {
    /** 技能伤害元数据 */
    private final SkillDamageData skillDamageData;

    public TerraSkillDamageEvent(LivingEntity caster, LivingEntity target, SkillDamageData skillDamageData) {
