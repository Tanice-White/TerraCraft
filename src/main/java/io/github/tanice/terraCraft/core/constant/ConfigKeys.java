package io.github.tanice.terraCraft.core.constant;
...
public final class ConfigKeys {
    ...
    public static final String ATTRIBUTE_SECTION= "attr";
    ...
    public static final String BUFF_ACTIVE_CONDITION = "condition";
    public static final String EQUIPMENT_SET = "set";
    ...
    public static final String MANA_RECOVERY_SPEED = "mana_recovery_speed";
